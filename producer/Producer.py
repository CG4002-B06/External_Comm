...
class Producer(Thread):
    def __init__(self, queue):
        ...
        self.client.connect(producer_constant.MESSAGE_QUEUE_URL, producer_constant.MESSAGE_QUEUE_PORT_NUMBER)
    ...
    def run(self):
        ...
        while True:
            ...
            self.client.publish(producer_constant.TOPIC1, payload=action, qos=2)
